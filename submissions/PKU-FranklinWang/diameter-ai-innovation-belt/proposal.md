...
> 概念情景估算，provisional状态，待现状普查与控规编制后核验，不构成审批依据。空间分母：总体设计范围（provisional）；时间基准：2030情景目标。
...
本方案以京张铁路遗址公园为载体，构建"中轴—对径"创新范式下的AI创新带城市设计。核心结论：对径式空间结构（一径·三核·双环·多庭）基于新空间经济三大机制+循环累积因果闭环，知识溢出效率与系统韧性**理论预期**优于传统点状集聚模式（**假设待验证**，需实证研究支撑）；聚焦大模型、具身智能、AI for Science三大方向，2035年目标AI产业规模3000亿元、AI人才15万人；"拆改留"分类策略+"共创·共建·共享"治理体系实现空间、产业、治理三焕新；六大风险类别均建立"识别—评估—缓解—责任—监控"完整闭环。
