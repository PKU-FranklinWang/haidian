---
title: "Centennial Jingzhang · Diameter AI Innovation Belt — Urban Design Proposal"
...
summary: "[Open Co-Creation Concept Proposal · Not a Substitute for Formal Planning] Rooted in the historical heritage of 'Centennial Jingzhang', structured around the spatial innovation of the 'Central Axis - Diameter' paradigm, & powered by the era-defining feature of 'AI empowerment', this proposal trinity constructs the 'Centennial Jingzhang · Diameter AI Innovation Belt'. Guided by the causal chain of New Spatial Economics — 'spatial quality enhancement → dynamic talent agglomeration → industrial innovation development' — as its theoretical mainline, it proposes the 'Central Axis - Diameter' spatial economic paradigm, using the Jingzhang Railway Heritage Park as a carrier to form an AI innovation central axis that stands in east-west symmetry with Beijing's traditional central axis, building a spatial structure of 'One Diameter · Three Cores · Two Rings · Multiple Courts'. Mapping the six-dimensional goals of the people's city to a six-type spatial quality supply system, integrating the cultural imagery of the Big Dipper pointing north & tracing origins to inspire innovation, & incorporating the four-tier temporal design of seasons · day-night · weekly rhythm · annual rings, it aims to create a world-class AI innovation ecosystem & a modern people-oriented city demonstration belt."
...
## — AI Innovation Belt Urban Design Proposal (v5.13.3)
...
> **Design Scope**: Centennial Jingzhang AI Innovation Belt (Coordinated Research 43.6km² / Overall Design 11.4km² / Key Areas 368.4ha)
...
> 📐 **Visual System v5.0 Optimization Note**: A0-A3 color mapping unification, warning label placement next to charts, metrics-evidence text fix, A0 layout optimization, & map label enlargement are in progress. Current version relies on text & metrics data.
...
> All figures are conceptual illustrations. Text & metrics data are authoritative.

## Chapter 1 Design Basis & Source List
> **📌 Overall Proposal Nature Statement**: This proposal is an open co-creation conceptual proposal. All spatial boundaries, area data, land use layout, FAR, building heights, demolition/rebuilding/retention ratios, investment estimates, benefit forecasts, & AI scenario settings are **conceptual scenario research parameters** (provisional), used only for design discussion & direction exploration. They do not represent official red lines, do not constitute statutory planning indicators, & are not approval or implementation basis. Final shall be subject to government statutory planning & special verification. Relevant positions in the full text have been marked one by one.
...
> **Important Notice**: All spatial boundaries, area calculations, & land use layouts are **provisional geometry at conceptual design stage**. They do not represent official red lines & do not constitute statutory planning or engineering basis.

### 1.1 Statutory Planning & Policy Basis

#### National Level
1. **"Outline of the 15th Five-Year Plan for National Economic & Social Development of the People's Republic of China"** [source:SRC-005]
...
2. **"New Generation AI Development Plan"** (Guo Fa [2017] No. 35) [source:SRC-005]
   - By 2030, AI theory, technology, & applications will overall reach world-leading levels
   - Building AI innovation highlands & talent highlands

3. **"Outline of the 15th Five-Year Plan for National Economic & Social Development of Beijing"** [source:SRC-006]
...
4. **"Beijing's 15th Five-Year Plan Period AI Industry Development Plan"** [source:SRC-003]
   ...
   - Scenario opening & application promotion
...
5. **General Secretary Xi Jinping's Important Expositions on Urban Work** [source:SRC-005]
   ...
   - Coordinating the three major links of urban planning, construction, & governance

6. **Spirit of the Central Urban Work Conference** [source:SRC-005]
   - Six-dimension goal of building a modern city that is "innovative, livable, beautiful, resilient, civilized, & smart"
   - Transforming urban development methods, improving urban governance systems, & enhancing urban governance capacity
   - Taking the path of urban development with Chinese characteristics

#### District Level
7. **"Outline of the 15th Five-Year Plan for National Economic & Social Development of Haidian District"** [source:SRC-007]
   - "Two Zones, Three Belts, Multiple Points" spatial pattern
   - AI industry highland construction
   - Urban renewal & quality improvement
...
8. **"Haidian District Plan (Territorial Spatial Plan) (2017–2035)"** [source:SRC-020]
   ...
   - Territorial spatial development & protection pattern

9. **"Centennial Jingzhang Railway Heritage Park Plan"** (to be verified by organizer·for background reference only·not for formal argumentation support) [source:SRC-021]
   - Overall layout of the 9-kilometer heritage park
   - Industrial heritage protection & activation

### 1.2 Centennial Jingzhang: From Railway Origin to Digital-Intelligence New Diameter

#### 1.2.1 Historical Heritage: A Railway & a Nation's Innovation
...
In the era of the digital-intelligence economy, the underlying logic of urban development is undergoing profound transformation. In the traditional industrial economy, industrial location depends on transportation costs, resource endowments, & scale effects. In the digital-intelligence economy, **innovation becomes the primary productive force, talent becomes the primary resource, & spatial quality becomes the primary determinant of talent location choice**.

Behind this transformation lies a deep-seated law revealed by New Spatial Economics: **spatial quality determines talent location; talent location determines innovation location; innovation location determines the industrial location of new quality productive forces**. In development stages dominated by knowledge-intensive industries, talents "vote with their feet" for high-quality spaces; enterprises cluster following talents; industries iterate & upgrade as talents agglomerate — forming a circular cumulative causation of "quality improvement → talent agglomeration → innovation growth → quality re-improvement."

Beijing, as the national science & technology innovation center, & Haidian District, as the core carrier of Beijing's AI industry, face the era proposition of how to transform advantages in science & education resources into AI innovation advantages. Along the Centennial Jingzhang corridor gathers a complete innovation chain from basic research to industrial application — ZhiYuan for original innovation, Zhongguancun for enterprise incubation, Dazhongsi for industrial transformation. Yet these innovation resources have long been separated by urban roads & functional zones, without forming a continuous spatial quality belt & innovation ecosystem chain.

#### 1.2.3 Design Approach: Diameter Intelligence Axis — Activating Innovation Potential Through Spatial Quality

Based on the above historical heritage & era proposition, this proposal presents the overall design concept of **"Centennial Jingzhang · Diameter Intelligence Axis"**: taking the Jingzhang Railway Heritage Park as the spatial main artery, transforming the century-old railway heritage into the innovation spatial skeleton of the AI era, & systematically improving spatial quality along the corridor through a Diameter AI Innovation Belt spatial structure, creating an AI innovation central axis spanning physical space to digital space, from industrial ecosystem to governance system.

**The core design logic** can be summarized as "three progressive steps":

**Step 1: Linking into a Diameter — The Diameter Paradigm in Spatial Structure.** Taking the Jingzhang Railway Heritage Park as the "diameter," connecting three core nodes — ZhiYuan AI Origin Community (North Core · Basic Research), ZhongZhiYuan AI Acceleration Zone (Mid Core · Startup Acceleration), & Dazhongsi AI Industry Cluster (South Core · Industrial Transformation) — forming a north-south quality gradient axis. The Diameter AI Innovation Belt spatial structure drives talent flow & agglomeration through quality gradients, enabling innovation resources to distribute orderly & link efficiently along the diameter.

**Step 2: Virtual-Physical Dual Diameter — Hyper-Dimensional Expansion in Spatial Dimension.** Superimposing a virtual spatial dimension on the physical diameter, constructing a "co-creation · co-construction · sharing" AI good governance system. The AI Conjecture Rankings gather collective wisdom to raise & solve problems (co-creation); the challenge-based system coordinates resources for joint breakthroughs (co-construction); innovation achievements benefit all people & improve the quality of production, life, & ecology (sharing). Virtual space & physical space mutually construct & reinforce each other — physical links are established & deepened online; new links emerge online & land & deepen offline.

**Step 3: Governance Safeguard — Good Governance Assurance in Spatial Operation.** Taking AI removability, non-smart equivalent paths, & manual review mechanisms as governance bottom lines, ensuring that AI always serves people & empowers cities. Taking public interest priority as the value anchor, so that innovation dividends benefit all citizens. The governance system & spatial system are designed integrally, ensuring the long-term, healthy, & sustainable operation of the innovation belt.
...
### 1.3 Theoretical Basis & Academic Literature

This proposal takes the New Spatial Economics founded by Professor Yang Kaizhong as the core theoretical foundation, & the important concept of the People's City as the value guidance, constructing a three-in-one design methodology of "theory - value - space". The core proposition of New Spatial Economics — "spatial quality drives talent agglomeration, knowledge exchange drives innovation growth" — provides solid theoretical support for the spatial design of the Jingzhang AI Innovation Belt.

#### 1.3.1 Core Theory: New Spatial Economics

New Spatial Economics breaks through the analytical paradigm of "transportation cost minimization" in traditional urban economics, shifting to a brand-new theoretical perspective of "spatial quality drives innovation growth", providing a systematic theoretical framework for the planning & design of urban innovation spaces in the AI era. Its core proposition holds that spatial economy is endogenously determined by the interwoven co-evolution of technological innovation, increasing returns, factor mobility, travel costs & transport costs, & spatial quality — spatial quality is no longer an exogenous residual "amenity" variable, but a core endogenous variable alongside transport costs & factor flows. [source:SRC-019]

New Spatial Economics reveals that in the DIKIT era, the relative importance of freight costs versus travel costs has undergone an important shift: face-to-face exchange has become the foundational mechanism of innovation, travel costs have risen to become a key constraint of the spatial economy, & spatial quality together with travel costs determines the "quality proximity effect" in talent location choice — talents tend to flow to areas with high spatial quality & low travel costs, even if nominal wages are lower. [source:SRC-019] Its core logic can be summarized as "three propositions + two mechanisms":

**Three Core Propositions**

**Proposition 1: Spatial Quality is the Core Driver of Dynamic Talent Agglomeration** [source:SRC-008]

In the innovation-driven development stage, the core of urban competition has shifted from traditional production factors such as land, labor, & capital to the attractiveness of spatial quality to high-human-capital populations. As the ultimate form of knowledge-intensive industries, the core production factor of the AI industry is talent; & the location choice & mobility decisions of talents are increasingly influenced by urban spatial quality — including ecological environment, cultural atmosphere, life convenience, social richness & other multi-dimensional quality factors.
...
The core mechanism of innovation is the flow, collision, & recombination of knowledge, especially face-to-face exchange of tacit knowledge. The efficiency of knowledge exchange largely depends on spatial organization — the closer the spatial distance, the richer the exchange scenarios, & the lower the mobility cost, the higher the frequency & quality of knowledge spillovers.

New Spatial Economics takes the "spatial transaction cost of knowledge exchange" as its core analytical variable: including the time cost of movement, the search cost of exchange, the adaptation cost of scenarios, etc. Compact spatial layout, mixed functional composition, & a hierarchical exchange venue system can systematically reduce the spatial transaction cost of knowledge exchange & improve the density & quality of innovation output.


**Proposition 3: Circular Cumulative Causation — Positive Feedback Between Talent Agglomeration & Spatial Quality Enhancement** [source:SRC-008]

The relationship between spatial quality & talent agglomeration is not one-way causation, but bidirectional circular cumulative causation: spatial quality enhancement attracts more high-human-capital talents to agglomerate, & the agglomeration of high-human-capital talents in turn promotes further improvement of spatial quality (such as upgrading demand for public services, consumption support for cultural facilities, participation & empowerment in community governance), forming a positive feedback cycle of "better quality → more talents → better quality".
...
> **Design hypothesis**: Diameter geometry (longest chord in circular scope) maximizes coverage & the midpoint has high accessibility. Requires empirical verification.
...
Dynamic talent agglomeration is not uniformly distributed, but flows along the quality gradient. Different types & developmental stages of innovative talents have systematic differences in their preferences for spatial quality: research talents prefer learning-oriented quality (academic atmosphere, quiet environment), entrepreneurial talents prefer innovation-oriented quality (exchange density, entrepreneurial services), & industrial talents prefer industry-oriented quality (business support, industrial chain completeness).

The quality gradient of "learning-oriented → innovation-oriented → industry-oriented" formed along the diameter axis not only corresponds to the spatial organization of the innovation chain, but also creates a "quality differential" for talent flow — talents flow between different nodes due to changes in quality preferences, & knowledge spillovers & innovation diffusion occur during the flow process. This dynamic talent flow based on quality gradients is the "blood circulatory system" of the innovation ecosystem.


**Green-Intelligent Productivity** [source:SRC-008]: Green + AI integration generates new productivity. The innovation belt serves as an experimental field — Jingzhang Heritage Park as green carrier, AI as intelligent core.


**Alternative Structure Comparison** (design hypothesis, not verified): Diameter, Cluster, & Ring mode comparisons are theoretical deductions requiring empirical verification.
...
5. **Important Concept of the People's City** [source:SRC-005]
    ...
    - Coordinating the three major links of planning, construction, & governance to promote high-quality urban development

6. **Modern City Six-Dimension Framework** [source:SRC-005]
    - The six-dimension goal of "innovative, livable, beautiful, resilient, civilized, & smart" proposed by the Central Urban Work Conference
    - Innovation is the primary driving force, livability is the fundamental goal, beauty is the ecological background
    - Resilience is the security guarantee, civilization is the spiritual core, & wisdom is the characteristic of the times

#### 1.3.3 Supporting Theories & Methods

7. **Urban Renewal Theory**
   - Progressive renewal & organic renewal methodology
   - Stock space quality improvement & functional mixing strategy
   - Historical heritage protection & activation utilization

8. **Industrial Cluster & Innovation Ecosystem Theory**
   - Porter Diamond Model & industrial competitiveness analysis
   - Triple Helix theory (government-industry-university collaborative innovation)
   - Entrepreneurship ecosystem theory

9. **TOD & Station-City Integration Theory**
   - Transit-Oriented Development (TOD) model
   - Rail micro-center & station-city integration design
   - Slow-traffic priority & job-housing balance strategy

10. **Resilient City Theory**
    - Urban disaster prevention & mitigation & emergency response system
    - Sponge city & stormwater management
    - Elastic supply of energy & water resources

### 1.4 Data Sources & Technical Materials

14. **Geospatial Data** [metric:haidian-gis^provisional]
    - Haidian District land use status data (2024)
    - Jingzhang Railway heritage site & surrounding building survey data
    - Road network & rail transit status data

15. **Industrial Economic Data** [metric:haidian-stats^provisional]
    - Haidian District AI industry statistical yearbook (2024)
    - Key AI enterprise directory & spatial distribution
    - Distribution of universities & research institutes & achievement transformation data

16. **Population & Talent Data** [metric:haidian-pop^provisional]
    - Haidian District population distribution & structure data
    - AI practitioner scale & profile
...
17. **Transportation Data** [metric:beijing-transport^provisional]
    ...
    - Road congestion index & travel OD analysis
    - Slow traffic system status assessment

### 1.5 Planned Research & Data Collection

> ⚠️ **Research Plan Statement**: The following are the **planned research work** of the proposal team. As of the submission date, all on-site surveys & interviews have not been completed.
>
> ⚠️ **v5.0 Statement**: All field surveys, site visits, building censuses, & interviews are **planned** & have not been conducted as of v5.0. Current situation descriptions are based on conceptual compilation of public remote sensing imagery & planning materials, & do not constitute field verification conclusions. The listed content is for research direction & planning reference only.
...
18. **Planned Site Survey** (starting from the second half of 2026)
    ...
    - **Sample Scope**: Entire Jingzhang Railway heritage site, three key districts, surrounding major communities & parks
    - **Authorization & Limitations**: Access to specific areas requires permission from relevant parties; imagery data is for design research only
...
19. **Planned Stakeholder Interviews** (to be advanced based on coordination progress)
    ...
    - **Sample Scope**: Planned to engage Haidian District government departments, universities & research institutions, AI enterprises, community residents, etc.
    - **Authorization & Limitations**: Informed consent required from interviewees; interview content is for design research only, no specific interviewee information will be disclosed
...
20. **Existing Public Data Compilation**
    - Background data compilation has been completed based on public reports & planning literature
    - All non-public sources are marked as "to be verified" & do not constitute formal supporting evidence
...
### 1.9 Source & Evidence Grading

This proposal follows the organizer's source registry system, with 21 sources cited. Evidence status markers: `[source:SRC-XXX]` source citation, `[metric:xxx]` metric data, `provisional` pending verification, `scenario-target` scenario goal, `observed` current status data. See Section 12.3 & sources.json for detailed source audit.
...
> **Figure Notice**: Uses provisional geometry. Areas & positions are conceptual only - not official red lines, not statutory or engineering basis.

![Site Overview: Three-Tier Scope Map](assets/figures/site-overview.png)
...
**Work Content**:
- AI industry development strategy & ecosystem construction research
- Regional coordination & spatial pattern optimization research
- Transportation & infrastructure system coordination research
- Talent community & public service system research
- Cultural inheritance & brand strategy research

**Core Task**: Clarify the strategic positioning, industrial direction, spatial pattern, & support system of the innovation belt from the regional level, providing strategic guidance for overall design.

#### 2.1.2 Tier 2: Overall Design Scope (11.4km²)

**Scope Definition**:
- Approximately 500–800 meters depth on each side of Jingzhang Railway Heritage Park
- North from Qinghua East Road, south to Xizhimen North Street
- Covering three core districts & surrounding linkage areas
- **Total area approximately 11.4 square kilometers** [metric:total-design-area]

**Work Content**:
- Urban renewal overall framework & strategies
- Functional layout & land use structure optimization
- Building scale & capacity control
- Road & transportation system optimization
- Public space & blue-green system design
- Urban character & building height control
- Key project layout & inventory
...
> **Metric Scope**: Unless noted, all indicators use 11.4km² scope & 2035 target year.
...
**Work Content**:
- District positioning & functional refinement
- Spatial structure & layout deepening
- Building renewal & renovation plans
- Traffic organization & slow traffic system
- Public space landscape design
- AI scenario implantation & smart design
- Risk assessment & response strategies

**Depth Positioning**: Key area conceptual scheme deepening research, proposing spatial form intentions & design guidelines for reference in subsequent architectural schemes & engineering design.

### 2.2 Spatial Relationship of Three-Tier Scope

![Three-Tier Scope Work Framework Diagram](assets/figures/01_spatial_structure_diagram.png)
...
### 2.3 Work Methodology & Technical Route

#### Theory-Led
With General Secretary Xi Jinping's People's City important concept as the fundamental guideline, the Central Urban Work Conference's six-dimension modern city framework (innovative, livable, beautiful, resilient, civilized, smart) as the goal orientation, & Yang Kaizhong's New Spatial Economics as the core methodology, build a theoretical integration system of "People's City Six-Dimension Goal × Spatial Quality Three-Dimension Framework × Diameter-type Spatial Paradigm", establishing a complete theory-policy-space closed loop.
...
**Correspondence Between Six-Dimension Goals & Three Dimensions of Spatial Quality**:
...
| Civilized | Learning (Cultural Sub-dimension) | Jingzhang Cultural Heritage Axis + Public Art |
| Smart | Innovative (Smart Governance Sub-dimension) | AI Urban Brain + Full Smart Scenario Coverage |

#### Three-Tier Connection
Precisely align with the national-Beijing-Haidian three-tier "15th Five-Year Plan", forming a planning system with layered strategy transmission & progressive spatial implementation.

#### Multi-Dimensional Integration
Integrate multiple professional fields including industrial planning, urban design, transportation planning, landscape design, & smart city to form an integrated solution.

#### Iterative Optimization
Establish a quantifiable, monitorable, & iterable spatial quality assessment system to ensure the dynamic adaptability & continuous optimization capability of the proposal.
...
The methodological core of this proposal is: taking the causal chain of New Spatial Economics — "spatial quality enhancement → dynamic talent agglomeration → industrial innovation development" — as the mainline, systematically transforming the six-dimensional goals of the people's city into six types of spatial quality supply strategies, & driving talent agglomeration & innovation growth through spatial design means.
...
Talent is the core mediating variable between spatial quality & industrial innovation. High-quality space attracts talent agglomeration, & talent agglomeration brings knowledge spillovers & innovation vitality, which in turn drives industrial development.

- **Flowing talents**: Talents are not "introduced" & then fixed in a certain space, but continuously flow between different quality nodes — from laboratories to incubators, from startup parks to industrial districts, from workspaces to living spaces. Flow itself generates knowledge spillovers.
- **Differentiated talent preferences**: Different types & developmental stages of AI talents have different preferences for spatial quality, requiring a differentiated quality supply system to attract & retain them.
- **Critical mass effect**: When talent density crosses a certain critical threshold, it will trigger the positive feedback of knowledge spillovers & enter a self-reinforcing agglomeration track.

**Stage 3: Industrial Innovation Development (Ultimate Goal)**

Dynamic talent agglomeration ultimately promotes industrial innovation development through mechanisms such as knowledge spillovers, startup incubation, & industrial chain self-organization. It is worth noting that industrial innovation development is not "built" by planning, but "emerges" on the basis of talent agglomeration.

The self-organized evolution of the innovation ecosystem follows the following logic: talents attracted by spatial quality reach critical mass → knowledge spillovers give birth to startup projects → startup projects attract capital & services → successful enterprises drive industrial chain agglomeration → industrial chain agglomeration further enhances spatial quality.

#### 3.1.2 Mapping Framework: Six-Dimension Goals → Six Types of Spatial Quality

The six-dimensional modern city goals of "innovative, livable, beautiful, resilient, civilized, & smart" proposed by the Central Urban Work Conference provide a value coordinate system for this proposal.
...
Based on the mapping framework above, this proposal systematically supplies six types of spatial quality through the diameter-type spatial structure. Each quality type has clear spatial carriers & design strategies:

**Six Quality Types & Spatial Supply Paths**:
...
The core of this positioning is not "building an AI highland", but **constructing a national-level learning-oriented & innovation-oriented spatial quality supply system** — through high-quality academic spaces, research environments, entrepreneurial atmospheres, & exchange scenarios, attracting & agglomerating top AI talents from across the country & even the world.
...
**Connotation Interpretation**:
The core of this positioning is not "becoming a growth pole", but **constructing a hub node for quality gradient coordination in the Beijing-Tianjin-Hebei region** — through the innovation-oriented & industry-oriented quality supply of the Diameter Intelligence Axis, attracting & transforming innovative talents & research achievements within the Beijing-Tianjin-Hebei range.

- **Quality supply type**: With innovation-oriented spatial quality as the hub (connecting the north-south quality gradient), with industry-oriented spatial quality as the export (achievement transformation & industrial landing)
...
- **Innovation output direction**: Technology transformation & pilot incubation, industrial chain collaborative innovation, two-way regional talent flow
...
**Core Support (New Spatial Economics Interpretation)**:
- Beijing's position as the core area of the international sci-tech innovation center means the high level of innovation-oriented quality supply capacity, forming a "quality highland" with both siphon & radiation effects on surrounding areas
...
**Connotation Interpretation**:
The core of this positioning is not "introducing enterprises & forming clusters", but **constructing Beijing's high-energy industry-oriented & smart-oriented spatial quality supply system** — through high-quality industrial supporting facilities, business services, application scenarios, & smart facilities, attracting AI industrial talent agglomeration.
...
**Core Support (New Spatial Economics Interpretation)**:
- Beijing's AI industry foundation (enterprise count, talent scale, & financing volume all rank among top nationally) provides the demand foundation & initial conditions for self-organized evolution of industry-oriented quality
...
|---|---|---|
| **AI Technology Source** | Basic research, frontier exploration, original innovation | Universities & institutes, key laboratories, joint R&D centers |
...
For the overall AI innovation spatial layout within the coordinated research scope, following the spatial organization logic of "core agglomeration, axial connection, & collaborative empowerment", an overall spatial pattern of "Three Zones & Two Wings" is formed.

#### 3.4.1 Three Zones: Three Core Functional Zones

**(1) Northern Innovation Zone — AI Independent Innovation Leading Zone**

Its scope covers Tsinghua Science Park, Peking University Science Park, Zhongguancun West District & surrounding areas, with an area of approximately 15.2 square kilometers.

Core functions include: basic research & original innovation, high-end talent cultivation & agglomeration, startup incubation & acceleration, international academic exchange & cooperation.

**(2) Central Core Zone — AI Technology Source & Talent Core Zone**

Its scope covers Wudaokou, Zhichun Road, & areas along Zhongguancun Street, with an area of approximately 13.8 square kilometers.

Core functions include: AI technology R&D & transformation, innovation & entrepreneurship ecosystem cultivation, talent housing & living services, & AI scenario testing & verification.

**(3) Southern Industrial Zone — AI Industry Agglomeration & Application Demonstration Zone**

Its scope covers Dazhongsi, Xueyuan South Road, & Xizhimen surrounding areas, with an area of approximately 14.6 square kilometers.

Core functions include: AI industry headquarters agglomeration, industry application solution R&D, scientific & technological achievement transformation & industrialization, & accelerated growth of innovative enterprises.
...
Along the Zhongguancun Street-Suzhou Street line, it connects scientific research resources such as universities & research institutes, national key laboratories, & engineering technology centers, constructing a complete innovation chain of "basic research - applied research - technology transformation".

**(2) East Wing — Scenario Application Demonstration Belt**

Along the Xueyuan Road-Huayuan Road line, various AI application scenarios & testing & verification bases are arranged, including city-level application scenarios such as smart transportation, smart communities, smart healthcare, & smart education.

The internal logic of the "Three Zones, Two Wings" spatial pattern is: taking the Three Zones as the core bearing bodies, respectively anchoring the upper, middle, & lower reaches of the innovation chain; taking the Two Wings as collaborative empowerment belts, respectively strengthening knowledge supply & scenario traction.

### 3.5 Benchmarking Study of Global AI Innovation Ecosystem Cases

Eight global cases were studied for reference: Silicon Valley (US), Kendall Square (Boston), Silicon Alley (NY), Toronto-Waterloo AI Corridor (Canada), King's Cross (London), Qianhai (Shenzhen), Zhangjiang (Shanghai), & Future Sci-Tech City (Hangzhou). Key lessons include talent-driven clustering, linear innovation corridors, university-industry linkage, & mixed-use spatial strategies.
...
![Brand Identity System](assets/figures/brand-identity-system.png)

### 3.7 Future City Vision

#### Vision Description
By 2035, the Centennial Jingzhang AI Innovation Belt will be built into:
- **World-class AI innovation ecosystem highland**: Gathering the world's top AI talents & enterprises, forming a globally influential AI industrial cluster
...
- **Model of urban renewal & innovation integration**: Benchmark for industrial heritage activation & utilization, model for existing spatial value reshaping
- **Green-intelligence integrated future city model**: Eco-Intelligent Agent City with deep integration of green low-carbon & smart technology
...
### 3.8 Central Axis - Diameter Innovation Paradigm: Theoretical Refinement & Model Value

#### 3.8.1 Paradigm Definition & Core Features: Theoretical Originality of "Diameter-type" Spatial Structure

This proposal puts forward the **"Diameter-type Spatial Structure" (DSS) paradigm** — a new linear urban spatial organization theory distinct from traditional TOD axes & corridor-style development. Traditional linear cities are built around transportation corridors, driven by accessibility decay — essentially "transport-oriented" corridor extension. The diameter-type paradigm is driven by **quality gradients** & grounded in the spatial philosophy of **diametrical opposition**, constructing three pairs of dialectical relationships: virtual-real, past-present, & human-AI.

**The Philosophical Connotation of Threefold Diametrical Opposition**:

- **Virtual-Real Diameter**: The physical diameter (Jingzhang Railway Heritage Park) & the digital diameter (AI digital twin space) exist in parallel, mutually constructing & reinforcing each other. The physical diameter provides quality spaces for face-to-face exchange, while the digital diameter provides connectivity & computing power beyond physical boundaries. This is not simply "offline + online" superimposition, but a **dual-density superposition in spatial economic terms** — physical spatial density determines the baseline capacity of talent agglomeration, while **Digital Spatial Density (DSD)** determines the circulation efficiency of innovation factors & the multiplier effect of knowledge spillover. This "dual-density model" breaks through the limitation of traditional spatial economics which only focuses on physical density, extending the agglomeration effect of AI industry from physical space to digital twin space.

- **Past-Present Diameter**: The historical heritage of Centennial Jingzhang (past) & the future orientation of AI innovation (present) form a temporal-spatial opposition. The Jingzhang Railway represents the "past perfect" of China's independent innovation in the industrial civilization era; the AI innovation belt represents the "future continuous" of China's leading innovation in the digital-intelligence civilization era. The diameter-type spatial structure is not a simple splicing of historical symbols, but through **space-time folding spatial narrative**, historical heritage becomes the spiritual anchor of innovation, & innovation becomes the contemporary expression of historical heritage.

- **Human-AI Diameter**: Human creativity & AI productivity form a collaborative opposition in space. Spatial design provides scenes for human face-to-face communication & inspiration collision (human path), while also providing infrastructure for AI perception, computation, & execution (machine path). The two are not in a substitutional relationship, but a **complementary-enhancing diametrical collaboration** — humans provide value judgment, creative intuition, & ethical anchors, while AI provides data processing, pattern recognition, & efficiency multiplication.
...
The core insight of this model: when physical density is constrained by urban planning regulations (FAR, building height), **increasing digital spatial density can break through physical constraints & achieve nonlinear growth in innovation output**. The Jingzhang AI Innovation Belt realizes the "low physical density, high digital density" innovation space paradigm by deploying high-density AI perception networks, edge computing nodes, & digital twin systems within limited physical space. This has universal significance for the path of "stock potential tapping, quality improvement" in urban renewal.
...
| Megrez (δ) | Jingzhang Railway Memorial Hall | 4th mag (mid-low intensity·cultural landmark) | ~5 min walk (~400m) | Cultural root · Heritage node |
...
#### 3.8.4 Comparison with Traditional Models & Promotion Value

The promotion value of the diameter-type innovation paradigm lies in: it provides a **"low-impact, high-empowerment" spatial economic model** for linear space transformation in urban renewal — no need for large-scale demolition & reconstruction, but achieving value multiplication of stock space through quality improvement + digital empowerment. For Chinese cities with abundant railway heritage, canal corridors, & industrial heritage, this paradigm provides a replicable path for spatial innovation.
### 3.9 Regional Synergy Development Mechanism

> ⚠️ **Conceptual Research Chapter**: Content in this chapter represents conceptual scenario research parameters. All boundaries/indicators/schemes are provisional & do not constitute statutory basis.

The Diameter AI Innovation Belt is a key node in Beijing's International Science & Technology Innovation Center network, building a "North-Science, East-Future, South-Translation, West-Source, Radiating Jing-Jin-Ji" synergy framework.
...
| Innovation Pilot Field | Stock renewal space for tech piloting | Bridges basic research & industrialization |
...
> Note: Regional synergy mechanisms & spatial patterns are conceptual research proposals, not statutory planning or official commitments.

## Chapter 4 Overall Design Area: Urban Renewal & Regulatory-Plan-Level Urban Design

> **📌 Task Book Response**: This chapter responds to "Urban Renewal & Regulatory Plan Depth", aligning with Haidian District Plan, proposing renewal framework, land optimization, & character guidance at master urban design level. All indicators are conceptual research parameters for reference only.
...
- West Wing Sci-Tech Services: Sci-tech finance, intellectual property, legal services, consulting & evaluation
...
![Three Key Areas Planning Diagram](assets/figures/key-areas.png)

### 4.2 Functional Layout Structure

![Diametric Spatial Structure Diagram](assets/figures/land-use-structure.png)


#### 4.2.1 Overall Layout: One Diameter · Three Cores · Two Rings · Multiple Courts

Based on new spatial economics' "spatial quality → dynamic talent agglomeration → industrial innovation" causal chain, the Jingzhang Innovation Diameter serves as the quality spine, three core districts as gradient quality nodes, east-west dual rings as circular flow support, & multiple innovation courtyards as mesoscopic exchange nodes, forming a well-proportioned & clearly layered spatial structure.
...
Based on "industry-city-people integration", high-intensity functional mixing reduces mobility cost & increases chance encounters.
...
|---|---|---|---|---|---|
| Collective Intelligence Park | 55% | 25% | 10% | 10% | Research talents are the mainstay, requiring a higher proportion of R&D office & residence, while focusing on the academic exchange function of public space |
| AI Origin Community | 45% | 30% | 15% | 10% | Entrepreneurial talents are the mainstay, requiring the high proportion of residence & commercial services (social + life), with relatively flexible office space |

The differentiated configuration of mixing ratios embodies the New Spatial Economics principle of "quality supply matching talent preferences" — different types of talents have different preferences for the ratio of functional mixing, & the three-core districts carry out targeted functional mixing design according to their respective dominant talent types, maximizing the matching efficiency of quality supply.
...
**Mechanism 1 · Linear Quality Agglomeration**: 6.2km linear public space attracts innovation talents. With longer contact interface than point spaces, the 500m zone on both sides serves ~8M sqm R&D office & 150K employees.
...
**Workflow Collaboration Mechanism**: The six agents are not linearly connected but form a **parallel iterative network collaboration** — site analysis feeds concept generation, concept generation triggers spatial generation, spatial generation submits to performance simulation, performance feedback iterates optimization, public participation runs through the whole process providing demand constraints, & the integration agent coordinates globally. This AI collaborative workflow compresses the traditional "serial design" cycle from months to weeks.

### 4.3 Spatial Implementation of the Central Axis - Diameter Innovation Paradigm: Beijing's Dual Central Axis Pattern

As a specific practice of the "Central Axis - Diameter" innovation paradigm in Beijing, the Jingzhang AI Innovation Belt takes Jingzhang Railway Heritage Park as the spatial carrier, constructing an innovation central axis that stands in east-west contrast with Beijing's traditional central axis, forming a dual central axis urban pattern of "ritual central axis — innovation diameter".

#### 4.3.1 Design Concept: Dual Central Axis Pattern

The planning & construction of the Jingzhang Railway Heritage Park should not be positioned merely as a linear green belt, but should be elevated to the **Jingzhang Innovation Diameter** — a sci-tech innovation central axis in western Beijing, echoing & standing alongside the traditional ritual central axis in the east, together forming Beijing's dual central axis urban pattern of "one ancient, one modern; one cultural, one technological".

```
 East (Traditional Axis)          West (Jingzhang Innovation Diameter)
      │                              │
...
- **Jing (Path/Diameter)** — Possessing both the order & ritual sense of an axis & the liveliness & approachability of a path, emphasizing walkability
- **Dui Jing (Diameter)** — Distinguished from the "development axis" of traditional planning (dominated by transportation & industrial functions), emphasizing the unity of walkability, spatial symmetry, cultural ritual sense, & innovation interactivity
...
The Jingzhang Innovation Diameter adopts a "seven-lane" cross-section design, from west to east: West Bicycle Lane — West Walkway — Central Landscape Belt (Heritage Memorial Path) — East Walkway — East Bicycle Lane — Ecological Buffer Zone — Innovation Interaction Belt.
...
Tree shade coverage ≥70%, with seasonal plant layers creating diverse spatial experiences & supporting the "quality gradient" spatial narrative.
#### 4.3.4 Daily Time Sequence Design: Commute · Vitality · Leisure · Mid-Night

Centered around the lifestyle patterns of innovative people, the diameter space adopts a time-sharing design strategy, presenting different spatial atmospheres & functional focuses throughout the day:

**Morning Peak · Commute Mode (7:00-9:30)**
- **Dominant Function**: Commuter passage, morning exercise
- **Space Focus**: East-west walkways & bicycle lanes operate efficiently, with pedestrian flow dominated by commuting between the three cores & connecting to rail stations
- **Supporting Services**: Breakfast carts, convenience kiosks, shared bicycle dispatch points, coffee outdoor seating opens early
- **Landscape Atmosphere**: Morning light through the shade, fresh & brisk, with runners & commuters moving side by side
...
- **Space Focus**: The innovation interaction belt & central landscape belt become popular areas for outdoor lunch & walking exchanges
...
- **Space Focus**: Pedestrian flow relatively stable, innovation courtyards become extended spaces for business negotiations & outdoor office work
- **Supporting Services**: Coffee tea houses, shared office kiosks, business centers operating normally
- **Landscape Atmosphere**: Dappled tree shadows, quiet & orderly, with occasional walking exchanges & team discussions
...
- **Landscape Atmosphere**: Sunset glow, lights coming on, warm & romantic night atmosphere gradually unfolds
...
- **Landscape Atmosphere**: Low-illumination warm point light system creates a quiet & comfortable nighttime walking environment, core nodes brightly lit
...
- Using the Jingzhang Innovation Diameter as the skeleton, weaving eastward & westward into surrounding blocks
...
- Industrial heritage type: Protection priority, activation & utilization, preserving historical memory

#### 4.4.3 Renewal Sequence & Rhythm

**Build the skeleton first, then fill in content**:
- Early stage: Full-line connection of Jingzhang Railway Heritage Park, infrastructure first

**Public construction first, then commercial office**:
- Prioritize construction of public service facilities & public spaces
...
| 2 | Jingzhang AI Computing Center | Collective Intelligence Park | 8 | 100K-card level intelligent computing infrastructure | 2026-2027 |
...
**"Centennial Jingzhang · Intelligence Creates the Future" — Innovative urban character blending tech sensation with historical sense**

- Inherit the industrial cultural genes of Jingzhang Railway, preserve historical memory

#### 4.6.2 Building Height Conceptual Guidance (TBD)

| Zone | Height Control | Description |
|---|---|---|
| 100m along Jingzhang Heritage Park | ≤24m | Ensure spatial openness & landscape permeability of the heritage park |
...
- AI Origin Tower proposed as landmark (~150m target), with heights gradually decreasing northward & southward

#### 4.6.3 Architectural Character Guidelines

**Overall Style**: Modern Minimalist + Tech Texture + Industrial Elements
- Main tone: Glass curtain wall + metal panels, reflecting tech sensation & modernity
...
![Street Innovation Quality Enhancement](assets/figures/street-innovation-quality.png)


#### 4.7.1 Layout of Sci-Tech Themed Street Exchange Spaces

The diameter innovation axis is not only a linear traffic corridor, but also an all-weather social & collaboration network for innovative people.

**(1) Street Innovation Pods**

Modular innovation pod units are set every 300-500 meters along the main diameter axis, with a single group building area of about 80-120 square meters, adopting full glass curtain wall + parametric metal perforated panel facade, & internally equipped with movable conference tables, digital whiteboards, video conference terminals & high-speed WiFi.
...
On the continuous ground-floor interface of buildings on both sides of the diameter axis, an interactive digital showcase wall system is set up, adopting an alternating layout of transparent OLED screens & physical display spaces, forming a virtual-real combined project release corridor.

**Technical Features**:
- Integrated design of transparent OLED screens & building glass curtain walls, without affecting indoor natural lighting

**(3) Street-Corner Innovation Living Rooms**

In the street-corner spaces around the seven innovation courtyards & the three core nodes, semi-open sci-tech innovation living rooms are set up, each with an area of about 200-400 square meters, positioned as the dual function of "park living room + urban showcase window".

**Functional Configuration**:
- Project pitch area: Equipped with professional-grade audio-visual equipment, capable of hosting small-scale launches, pitches, & salons

#### 4.7.2 Unmanned Catering & Smart Service System

Along the diameter axis, build a smart catering system for the "15-minute innovation life circle" — unmanned, intelligent & low-carbon, adapting to tech workers' fast-paced lifestyle needs.
...
- **AI Unmanned Restaurants (Central Core + North Core)**: One per core area (AI Origin + Zhongzhiyuan North), ~300-500sqm, with cooking robots, auto-delivery & frictionless payment, capacity 80-120 diners, offering Chinese/Western/meal-kit options. Transparent kitchen design enhances tech experience.

- **Unmanned Convenience Stores + Light Food Cabinets (Evenly Distributed)**: Set up a combination of unmanned convenience stores & smart light food cabinets every 500 meters along the main diameter axis, providing instant consumption categories such as pre-made meals, salad sandwiches, fruits, coffee & tea. The equipment adopts intelligent temperature control & freshness management systems, & AI algorithms dynamically adjust the product structure & replenishment strategy based on the surrounding population profile.

- **Mobile Food Trucks + Coffee Robots (Node Supplement)**: In the seven innovation courtyards & public activity nodes, deploy movable smart food trucks & robotic arm coffee stations as elastic catering supplements during peak hours & large-scale events. The robotic arm coffee station can make 20+ types of specialty coffee drinks, with an average serving time of 45 seconds, adapting to the rapid replenishment needs of innovative people.

**(2) Smart Service Supporting Facilities**

- **Unmanned Delivery Network**: Lay dual channels of underground logistics delivery pipelines & ground unmanned delivery vehicles along the diameter axis, targeting 30-minute delivery of catering, documents, & materials within the park. Delivery tasks are uniformly managed by the AI scheduling system, dynamically allocating transport capacity resources according to real-time road conditions & priority levels.
- **Smart Public Toilets & Rest Pods**: Set up a combination of smart public toilets & capsule rest pods every 800 meters along the diameter axis, equipped with smart sensor sanitary ware, ambient air purification systems & free WiFi; the rest pods provide 15-30 minute short rest services, equipped with zero-gravity seats & white noise systems.
- **AI Guide & Information Screens**: Interactive AI information terminals are set up at key street nodes, supporting voice Q&A, route navigation, event query, service reservation & other functions, simultaneously accessing multi-language systems in Chinese, English, Japanese & Korean, serving international innovative people.
...
- **Smart Light Poles**: One pole integrates multiple functions such as lighting, 5G/6G base stations, environmental monitoring, traffic signal lights, public WiFi, & emergency calls, with reserved modular expansion interfaces on the pole body
- **Underground Comprehensive Utility Tunnel**: Pipelines for electricity, communications, water supply & drainage, & cold chain logistics are uniformly placed in the tunnel, avoiding repeated excavation & ensuring high-reliability operation of the innovation district
...
- **Daytime**: Mainly work commuting & business exchange, pod meeting rooms & showcase walls are frequently used, & unmanned catering operates at full capacity during the lunch peak
- **Evening**: Sci-tech innovation living rooms host salon pitches, street pods switch to leisure social mode, outdoor bars & coffee robots set up outdoor seating
- **Night**: Digital showcase walls switch to public art mode, low-illumination warm point light systems create a quiet innovation atmosphere, & 24-hour convenience stores & rest pods guarantee the needs of late-night entrepreneurs
- **Weekends**: Some sections of the street are temporarily pedestrianized, hosting innovation markets, sci-tech carnivals, outdoor pitches & other activities to activate weekend vitality of the district
...
This chapter has established the overall spatial structure of "One Diameter · Three Cores · Two Rings · Multiple Courts" & the seven-lane diameter cross-section at the master plan level. The next chapter enters detailed design of key areas, following a clear logical progression: **seven featured AI scenario nodes (Seven-Scenario Connecting Path)** strung along the diameter axis, corresponding to the Big Dipper constellation & arranged by innovation gradient from north to south; **three districts (A1 Collective Intelligence Park · A2 Origin Community · A3 Dazhongsi)** respectively host three innovation stages — basic research acceleration, cross-disciplinary incubation, & industrial transformation — forming a dual-layer implementation system of "node stringing + district carrying" that translates the overall spatial quality gradient into perceptible, implementable detailed design.


## Chapter 5 Detailed Design of Key Areas

> **📌 Task Book Response**: This chapter responds to "Detailed Design of Key Areas", conducting in-depth design for three core districts, covering spatial structure, building renewal, transport, public space, & AI scenarios. All indicators are conceptual research parameters for reference only.
...
![Transportation System & Blue-Green Space Structure](assets/figures/mobility-bluegreen.png)

#### 5.1.1 District Overview & Positioning
...
**Economic logic**: Zhongzhiyuan is the **high-density learning-quality supply area** — adjacent to top universities (Tsinghua, PKU, Beihang, BUPT) with richest academic resources & densest research talent. This learning quality is talent agglomeration's "source endowment" & the belt's knowledge spillover origin.
...
- Diameter axis northern endpoint — southward talent flow carries knowledge to incubation & transformation
#### 5.1.2 Spatial Structure

**"One Corridor · Two Belts · Three Parks · Multiple Courtyards" Spatial Structure**

- **One Corridor**: Jingzhang Innovation Diameter (Collective Intelligence Park Section) — innovation hub & interaction bond
- **Two Belts**:
- **Three Parks**:
...
|---|---|---|
| Preservation & Enhancement | 40% | Research buildings with good quality, functional optimization, facade improvement, smart renovation |
...
3. **Seven Featured AI Scenario Courtyards + One Garden**
   ...
   - Railway Memory Garden serves as the "North Star" imagery node for cultural heritage & spiritual anchoring
   - Each courtyard equipped with coffee, pitch space, & shared meeting rooms

#### 5.1.6 AI Scenario Design

**Industrial Testing & Verification Scenarios**:

1. **Large Model Training & Inference Test Field**

2. **Embodied Intelligence Testing & Verification Park**

3. **AI for Science Joint Laboratory Cluster**

#### 5.1.7 Risk Assessment & Response
...
#### 5.1.8 Virtual Space Functional Positioning: Conjecture Plaza

The virtual space of the Collective Intelligence Park district is positioned as the **"Conjecture Plaza"**, the birthplace of AI basic research conjectures & an open discussion space. Corresponding to the learning-oriented quality characteristics of the physical district, it adheres to the principles of **low barrier, high openness, & strong academic rigor**, encouraging researchers worldwide to freely publish cutting-edge AI scientific conjectures & engage in interdisciplinary discussion, virtually strengthening its functional positioning as the "knowledge source."
### 5.2 A2 District: AI Origin Community (Wudaokou + Zhichun Road)

#### 5.2.1 District Overview & Positioning
...
**Positioning**: AI technology source & talent vitality core, energy hub of the innovation diameter, destination for global AI young talents, main front for "from 1 to 100" technology incubation.

**Economic logic**: AI Origin Community is the **high-density innovation-quality supply area** — at the diameter midpoint, it's the intersection/converter of learning & industry quality. Northern university knowledge meets southern industrial market access, generating greater collision & vitality.
...
**Core value**:
- Wudaokou's international atmosphere & youth convergence — core innovation-quality elements
...
| Renewal Type | Building Area Proportion | Strategy Description |
|---|---|---|
| Preservation & Optimization | 50% | Buildings with good quality, functional optimization, facade renovation, smart renovation |
...
#### 5.2.7 Risk Assessment & Response
...
#### 5.2.8 Virtual Space Functional Positioning: Acceleration Lab

The virtual space of the AI Origin Community is positioned as the **"Acceleration Lab"**, a virtual-physical collaborative field for achievement verification & startup acceleration. Corresponding to the innovation-oriented quality characteristics of the physical district, it adheres to the principles of **rapid verification, resource docking, & growth acceleration**, providing full-factor acceleration services for high-quality projects emerging from the Conjecture Rankings, building a progressive acceleration mechanism of "online pre-verification → offline deep incubation."
### 5.3 A3 District: Dazhongsi AI Industry Agglomeration Zone

#### 5.3.1 District Overview & Positioning
...
**Positioning**: AI industry landing & application promotion gateway, southern gateway image display zone, main front for "from 100 to N" industry amplification.

**Economic Logic of Positioning**:
From the perspective of New Spatial Economics, the core value of Dazhongsi District lies in it being **the high-density supply area of industry-oriented spatial quality** — located at the southern end of the diameter axis, it is the terminal link where innovation achievements are transformed into industrial value. Here, it undertakes startup projects & technological achievements incubated & matured at the central origin, & through the agglomeration & scaling of the industrial chain, innovation value is transformed into industrial value & economic output.
...
- **Talent agglomeration type**: Enterprise executives, industrial engineers, product operations, business services & other industrial talents
...
- **Position in the diameter gradient**: The southern terminal of the quality gradient, the "sink point" of talent flow & the starting point of feedback
...
| Renewal Type | Building Area Proportion | Strategy Description |
|---|---|---|
| Preservation & Optimization | 45% | Office buildings with good quality, functional enhancement, facade renovation |
...
3. **International AI Exchange & Exhibition Center**
...
#### 5.3.7 Risk Assessment & Response

#### 5.3.8 Virtual Space Functional Positioning: Challenge Hall

The virtual space of the Dazhongsi district is positioned as the **"Challenge Hall"**, the core platform for industrial demand release & technological breakthrough docking. Corresponding to the industry-oriented quality characteristics of the physical district, it adheres to the principles of **problem-oriented, result-oriented, & value-oriented**, aggregating real enterprise demands & technical challenges, promoting AI technology from lab to industrial application.
...
**Core Concept**: Building on the physical "One Diameter · Three Cores · Two Rings · Multiple Courts" structure, a **virtual spatial dimension** is superimposed, forming a new spatial paradigm of "physical diameter + virtual diameter" running in parallel, mutually constructing & reinforcing each other. The virtual space serves as the **"digital twin layer + collaboration enhancement layer"** of physical space — both a digital mapping of physical space & a hyper-dimensional accelerator for innovation collaboration.

**Dual Diameter Mutual Construction Mechanism**:
- **Physical links → Deepened online**: Encounters, exchanges, & collaborations in physical space are extended, deepened, & scaled in virtual space, transcending temporal & spatial constraints.
- **New links online → Landed offline**: Collaborative relationships, knowledge networks, & innovation consensus formed in virtual space precipitate into physical space, triggering resource allocation & spatial utilization.
- **AI Conjecture Rankings** serve as the core mechanism for virtual-physical integration & the engine of talent aggregation — global intelligence gathered online, implementation & transformation landed offline, forming circular cumulative causation of "online emergence → offline precipitation."
...
- **Collective Intelligence Park (North Core) — Conjecture Cradle**: Virtual "Conjecture Plaza," the source of basic research conjectures, encouraging open discussion & low-barrier publishing.
- **AI Origin Community (Mid Core) — Acceleration Field**: Virtual "Acceleration Lab," a virtual-physical collaborative field for achievement verification & startup acceleration.
- **Dazhongsi AI Industry Cluster (South Core) — Challenge Arena**: Virtual "Challenge Hall," a docking platform for industrial demand & technological breakthroughs.

**Governance Core: "Co-Creation · Co-Building · Co-Sharing" AI Good Governance System**. The deep integration of virtual-physical dual diameter relies on a throughout governance mechanism — **Co-Creation** gathers collective wisdom to pose & solve problems, with AI Conjecture Rankings as the core carrier; **Co-Building** pools collective efforts to coordinate resources, with three-core spatial dynamic allocation connecting supply & demand; **Co-Sharing** ensures all people benefit from innovation achievements, with public interest priority guarantee. Together they form the "space-network-governance" trinity development paradigm of the AI Innovation Belt.


### 5.5 Seven Featured AI Scenario Spatial System

The seven featured AI scenario nodes are distributed along the Jingzhang Innovation Diameter, each corresponding to a different AI application domain & carrying specific spatial quality characteristics. Together, they form the spatial implementation of the "quality gradient" concept from learning-oriented (north) to industry-oriented (south).
...
Between the seven featured AI scenario nodes, the main walkway of Jingzhang Railway Heritage Park serves as the backbone, forming a continuous **"Seven-Scenario Connecting Path"** — both a pedestrian corridor & a spatial carrier for the quality gradient narrative. Walking from north to south along the path, scenarios progress from basic research to industrial application, & spatial atmosphere transitions from quiet academic to vibrant urban.
...
2. **Cycling Paths** (3m×2, one on each side): Colored asphalt, supporting smart cycling navigation & unmanned delivery vehicles, green-buffered from walkways
3. **Central Landscape Belt** (6-8m): Preserved railway heritage, linear green space + railway-themed landscape installations, combining heritage commemoration & ecological leisure
...
The seven stations correspond to the seven AI scenario themes, each with unique theme identification, lighting design, & interactive experience content, forming a spatial narrative rhythm of "one station, one scene, step by step advancing". The connecting path system simultaneously carries the spatial narrative of quality gradient — from north to south, the landscape gradually transitions from tranquil academic gardens to vibrant urban interfaces, echoing the progressive logic of AI innovation from basic research to industrial application.

> **Note**: All spatial boundaries & scenario layouts above are **conceptual proposals (provisional)**. Specific locations need further deepening in combination with statutory planning & ownership research.

#### 5.5.2 Co-Creation Showcase: Digital Intelligence Economy Rent

Distributed along the Jingzhang Innovation Diameter, **Co-Creation Showcase Spaces** are an innovative spatial product proposed in this plan. Through large LED displays, holographic projections, & immersive installations, enterprises & universities can showcase research results with paid visualization services, creating a new business model of **"digital intelligence economic rent"**.

**Core Concept**: Traditional urban rent comes from location; the new rent in the AI era comes from **attention & knowledge visualization**. The innovation belt gathers foot traffic & attention through high-quality public space, transforming the linear interface into an operable "knowledge showcase window." Enterprises pay to display cutting-edge results, the public receives free science education, & the city gains vitality — a triple-win digital economy model.

**Spatial Forms**: Large interactive screen walls (8-15m wide) along the main promenade; projection showcase bands on building facades & under-bridge spaces; holographic display pavilions in three core squares; transparent OLED vitrines along commercial interfaces.

**Operating Model**: ① Enterprise/university paid subscription with tiered pricing (core > node > general); ② 2-3 hours daily public service hours for free science content; ③ Desensitized interaction data feeds back to product optimization; ④ Regular "Result Launch Days" & "Lab Open Days" brand events.

**Value**: Transforms purely consumptive public space into revenue-generating knowledge media, makes frontier AI research visible to public, attracts talent, & enhances Haidian's AI industry brand visibility.


---

## Chapter 6 AI Innovation Ecosystem, Personas, & AI+ Scenarios
...
2. **Multi-Agent Layer**: Simulate spatial behavior patterns of four types of agents — AI researchers, entrepreneurs, industrial talents, & residents — with spatial forms emerging from agent interactions
...
4. **Performance Feedback Layer**: Real-time calculation of accessibility, exchange efficiency, quality balance & other indicators, iteratively optimizing generation results
...
AI innovation ecosystems need concrete spatial quality carriers. The full chain from basic research to industry corresponds to a complete quality gradient from learning to industry. **Each innovation chain link needs specific quality support; gradient continuity determines ecosystem integrity & efficiency**.
...
**Gradient continuity is critical**: quality faults block talent flow & spillovers, breaking the chain. Diameter structure linearly distributes learning-innovation-industry gradients along the axis, ensuring smooth transitions.
...
Talent frequency, direction, & quality of flow determine ecosystem vitality. The diameter design maximizes talent flow efficiency through high-quality corridors, gradient nodes, & exchange networks. The "source-flow-sink" gradient spatial organization ensures both specialized division of labor & efficient knowledge spillover.
...
### 6.2 AI Talent Profile & Demand Analysis
...
![Talent Community Layout Diagram](assets/figures/04_talent_community_layout.png)
...
#### 6.2.2 Four Types of Radiation-Driven Population Profiles

The Jingzhang AI Innovation Belt not only serves core practitioners but also attracts mobile, visiting, & experience-oriented populations through high-quality spatial supply, forming a "magnetic field effect" of dynamic talent agglomeration. Annual flow of the four radiation populations is estimated at over 200,000 person-times:

**Profile 6: Academic Exchange Visitors** — Ages 25-55, domestic & international scholars & industry experts, short-term visits (1-7 days) for conferences & exchanges
- Needs: High-quality conference spaces, academic salons, scholar apartments, S&T achievement exhibitions, international dining options
- Scale: ~50,000/year

**Profile 7: Training & Learning Participants** — Ages 20-45, students & professionals, mid-term visits (1 day-1 month) for training & certification
- Needs: Training classrooms, AI practical training bases, learning-type apartments, certification exam centers, night study amenities
- Scale: ~60,000/year

**Profile 8: Cultural Tourism Visitors** — All ages, families & tech enthusiasts, short visits (half day-2 days) for打卡 experiences
- Needs: AI experience center, railway heritage exhibition, cultural & creative shops, specialty dining, multilingual guided tours
- Scale: ~50,000/year

**Profile 9: Leisure & Lifestyle Visitors** — All ages, nearby residents & sports enthusiasts, high-frequency short visits (multiple times per week)
- Needs: Running & cycling paths, park green spaces, coffee outdoor seating, children's playgrounds, community markets, pet-friendly facilities
- Scale: ~40,000/year

#### 6.2.3 Dynamic Talent Agglomeration & Radiation-Driven Effect

The Jingzhang AI Innovation Belt forms a **"Core-Radiation-Influence" three-tier dynamic talent agglomeration system**:

- **Core Innovation Belt (500m)**: Directly serves ~150K AI practitioners, with complete closed-loop of office/labs/apartments/amenities
- **Radiation-Driven Zone (2km)**: Annual flow of ~200K mobile people, driving surrounding hotels, dining, & retail services, activating spatial vitality
- **Regional Influence Zone (5km+)**: Radiates the Beijing-Tianjin-Hebei innovation network, links with three major science cities, & exports institutions & models

**Dynamic Talent Agglomeration Mechanism**: ① Quality attraction — spatial quality trades for talent agglomeration, non-salary competitiveness; ② Flow activation — mobile populations bring diverse collisions & spark innovation inspiration; ③ Network effect — higher density = stronger knowledge spillovers; ④ Continuous evolution — update spatial supply along with industrial iteration to maintain long-term attractiveness

#### 6.2.4 Talent Community Spatial Layout
...
- **Research Community** (North): Near Zhongzhiyuan & universities, talent apartments + shared facilities
...
#### Scenario Card 1: Large Model Training & Inference Test Field (Industrial Testing & Verification Scenario)

| Item | Content |
|---|---|
| **Scenario Name** | Large Model Training & Inference Test Field |
...
| **Space Requirement** | ~80,000 sqm computing center + ~150,000 sqm office & lab space |
...
![AI Scenario Distribution Map](assets/figures/03_ai_scenario_distribution.png)

#### Scenario Card 2: Embodied Intelligence Testing & Verification Park (Industrial Testing & Verification Scenario)

| Item | Content |
|---|---|
| **Scenario Name** | Embodied Intelligence Testing & Verification Park |
| **Scenario Type** | Industrial Testing & Verification |
...
| **Innovation Value** | Filling the gap in domestic embodied intelligence testing infrastructure, accelerating product iteration & commercialization |
...
#### Scenario Card 3: AI+FinTech Innovation Test Field (Industrial Testing & Verification Scenario)
...
| **Space Requirement** | ~30,000 sqm office & testing space |
...
| **Innovation Value** | Building a replicable & promotable AI+future community standard paradigm |
...
| **Innovation Value** | Promoting both equity & quality in education, cultivating new talents for the AI era, forming a replicable smart education paradigm |
| **Extended Industry** | Smart education product R&D & enterprise agglomeration |
...
| **Experience** | Consumers can experience full-process AI-empowered shopping & dining services |
...
| **Innovation Value** | Building a new paradigm of urban governance in the AI era, achieving dual demonstration of industrial & urban governance, improving governance refinement |
...
| **Location** | Jingzhang Railway Heritage Park · Full route |
...
| **Experience** | Visitors can "travel through" different eras via AI technology, experiencing the historical changes of Jingzhang Railway |
...
| **Partner Institutions** | Tsinghua, Peking University, CAS & other universities & research institutes |
...
| **Innovation Value** | Filling the gap in deep integration of AI & social sciences, integrating railway heritage activation with AI art innovation, creating a new AI humanities landmark |
...
| **Services** | Full-cycle AI health management services for community residents, combined diagnosis by AI medical enterprises & tertiary hospitals |
...
| **Talent Community Integration** | Embedded on the ground floor of talent apartments, providing exclusive health records, psychological counseling, & fitness guidance for innovation talents, improving retention through wellness support |
...
#### Scenario Card 13: AI Conjecture List (Virtual-Physical Fusion) + AI Smart Manufacturing
...
#### First Trial & First Use Policy

#### Scenario Evaluation & Iteration
...
> **Concept Proposal**: The governance framework below is a conceptual proposal & does not constitute any official policy commitment.
...
- **Four-Right Separation**: Data ownership belongs to the public, usage rights to enterprises, supervision rights to government + third parties, & benefit rights to multi-stakeholder sharing

**Three-Core Cross-Node Governance Protocols**: Data classification sharing (core data localized + derivative data cross-district flow), computing power collaborative scheduling (elastic computing pool on-demand allocation), model filing interconnection (filed at one core, recognized by all three), clear responsibility boundaries (operator / algorithm provider / regulator tripartite rights & responsibilities), emergency linkage (cross-node coordinated response).

**Algorithm Filing & Audit**: Public AI systems on the diameter axis implement "double filing + annual audit" — pre-launch filing, major change re-filing, annual third-party audit with public disclosure.
...
> ⚠️ The following compliance classification is a preliminary conceptual framework proposed by the design team & requires review & confirmation by professional legal teams. It does not constitute formal legal advice.

AI scenarios are classified into four levels based on data sensitivity, public impact, & risk level, with corresponding review mechanisms:
...
A dynamic compliance review mechanism is established: regular reassessment as regulations evolve, with rollback & emergency response procedures.

## Chapter 7 Land Use, Building Scale, & Retain-Renovate-Demolish Strategy
...
- Industrial land, research land, residential land, & commercial service facility land are mixed & distributed
- Land use functions along the Jingzhang Railway heritage site are complex with severe spatial fragmentation
...
|---|---|---|---|
| Residential Land | ~285 | 25% | Clustered distribution on east & west sides |
...
**Planning Goals**: Optimize land use structure, increase the proportion of industrial space, & improve public service & public space supply.
...
### 7.2 Building Scale & Capacity Control
...
> The FAR & building scale in the table below are **conceptual suggestion parameters** for professional teams to further study, not statutory control indicators.
...
**Demolition Category**:
- Dilapidated buildings with poor quality & safety hazards
- Inefficient buildings with extremely low land use efficiency
- Buildings that seriously affect the overall urban layout & public space
- Buildings that do not conform to industrial development direction & have no renovation value

**Rehabilitation Category**:
- Buildings with good structural quality but functions not meeting current needs
- Buildings whose use efficiency & spatial quality can be greatly improved through renovation
- Buildings with historical value or character features that need protection & utilization
- Buildings that can meet AI industry usage needs through renovation

**Preservation Category**:
- Buildings with good quality, complete functions, & consistent with planning positioning
- Important public buildings & infrastructure
- Historical protection buildings & cultural relics
...
1. **Build first, then demolish; resettle first, then move**: Prioritize construction of resettlement housing & new industrial space before advancing demolition work, ensuring smooth transition
2. **Targeted policies, precise renewal**: Formulate renewal strategies based on building quality, function, value & other factors, avoid one-size-fits-all
3. **Protection priority, heritage memory**: Buildings with historical value & industrial heritage receive priority protection, activation & utilization
4. **Benefit sharing, win-win for all**: Establish benefit sharing mechanism among government, enterprises, & residents, forming renewal synergy
...
- Underground space utilization of Jingzhang Heritage Park (municipal facilities, parking, storage)
...
## Chapter 8 Transport, Rail, Municipal Infrastructure, & Public Services
...
1. **Connect Dead-End Roads**:
   - Identify & connect all T-junctions & dead-end roads
   - Increase north-south & east-west connection channels
   - Resolve spatial division caused by railways & rail transit

2. **Narrow Roads, Dense Network**:
   - Implement narrow roads dense network model in three key districts
   - Increase branch roads & lane streets, improve road network accessibility
...
3. **Intersection Optimization**:
   ...
   - Set up pedestrian safety islands & secondary crossing facilities
   - Optimize signal timing, AI intelligent control

4. **Traffic Calming**:
   - Implement traffic calming in residential areas & pedestrian priority zones
...
- Shared parking mechanism: Office & residential parking shared during off-peak hours
...
- Reservation parking & shared parking platform
- Unattended & frictionless payment
...
| Zhichun Road Station | Tier 1 | Startup incubation, transfer hub | Existing station renovation & upgrading |
...
#### 8.2.3 Integrated Design of Rail & Surroundings

**Integrated Design Key Points**:
- Station entrances directly connected to surrounding buildings underground/above-ground
- Commercial, office, & public service functions clustered within 500m of stations
...
|---|---|---|---|
| Pedestrian Main Channel | Central walkway of Jingzhang Innovation Diameter | 6-8m | North-south pedestrian main axis, innovation interaction |
| Pedestrian Secondary Channel | Main street sidewalks | 3-5m | Daily commute, commercial walking |
| Pedestrian Branch Channel | Lane streets & community walkways | 2-3m | Community accessibility, neighborhood interaction |
...
- **Main Cycling Lane**: 3.5m on each side of Jingzhang Innovation Diameter, north-south through traffic, independent right-of-way
- **Secondary Cycling Lanes**: Along main urban roads, mainly east-west
- **Branch Cycling Lanes**: Bicycle lanes within communities & parks
...
- Smart parking & electronic fence management

#### 8.3.3 "Three Paths + One Green" Pattern

Build a slow traffic & ecological system of "Three Paths + One Green" along Jingzhang Railway Heritage Park:

![Jingzhang Innovation Diameter Cross-Section Diagram](assets/figures/02_jingzhang_cross_section.png)
...
- Unified computing power scheduling & management
- On-demand allocation, elastic supply
- Computing power trading & billing system
...
- Quantum encrypted communication for core institutions & important facilities
- Secure transmission of government & financial data
...
- Microgrid & island operation capability
...
- Priority use of reclaimed water for municipal miscellaneous use, greening, & industrial water
- Reclaimed water utilization rate ≥50%

#### 8.5.2 Waste Treatment

**Smart Waste Sorting & Recycling System**:
...
#### 8.6.1 Configuration Standards & System
...
| AI Science & Technology Museum | 1 | New | Technology experience + science education |
| Jingzhang Railway Memorial Hall | 1 | New | Cultural landmark + education base |

---

## Chapter 9 Blue-Green Network, Public Space, & Urban Character
...
**One Spine**: Jingzhang Railway Heritage Park Green Spine
...
- Central Corridor: Jingzhang Heritage Park Green Spine
- East Corridor: Xiaoyue River Ecological Green Corridor

**Multiple Points**: Multiple urban parks & community green spaces
- City-level parks: 3
...
### 9.2 Jingzhang Railway Heritage Park Vitality Belt

#### 9.2.1 Overall Positioning

**"China Innovation Timeline" — A composite urban public space integrating ecological green corridor, cultural corridor, innovation interaction, & leisure recreation**

With the 9km Jingzhang Railway heritage site as the carrier, integrating three veins of railway culture, Zhongguancun culture, & AI culture, create a linear public space showcasing China's independent innovation spirit.

The overall design of the park continues the spatial narrative of "born from the source", taking the northern Tsinghua Garden Station heritage site as the historical origin, & unfolding a time-space dialogue between a century of railway memory & the future of AI innovation southward along the main diameter.

#### 9.2.2 Sectional Themed Design

| Section | Corresponding District | Cultural Theme | Time Coordinate | Core Experience |
|---|---|---|---|---|
| North Section | Collective Intelligence Park | Starting point of independent innovation | 1909 · Jingzhang Railway Opening | Railway heritage display, Zhan Tianyou Memorial, engineering technology history |
...
1. **Collective Intelligence Park Station · Railway Memory Node**
   - Preserve original station building & railway tracks
   - Jingzhang Railway Memorial Hall
...
2. **Origin Station · Innovation Center Node**
   ...
   - Large event lawn & outdoor amphitheater
...
- Integrating exhibition, rest, & services
- Design style: modern & minimalist, incorporating railway elements
...
At the northernmost end of the diameter, set up **Polaris Plaza** as the spiritual origin & directional anchor of the entire innovation belt:
...
- **Inscription**: Engraved with four characters "Zhi Qi Xin Cheng" (Wisdom Starts a New Journey), echoing the spiritual inheritance from railway independent innovation to AI independent innovation of the centennial Jingzhang
- **Functional Positioning**: City-level celebration space for New Year countdown, sci-tech innovation week opening ceremonies, & major achievement releases

---

#### 9.3.4 Diameter-type Innovation Street Public Space

Street public space is the most open & inclusive public interface of the innovation belt, & also the type of space that innovative people encounter most frequently in their daily lives. The diameter-type innovation street breaks through the traditional street logic of "traffic priority" & shifts to "social priority, innovation priority", reconstructing the linear traffic corridor into a composite innovation space corridor integrating exchange, exhibition, leisure, & service.

**Design Principles**:

- **Continuity Principle**: Construct a continuous street public interface with a total length of approximately 6.2 kilometers along both sides of the main path of Jingzhang Heritage Park, ensuring that innovative people can conveniently access various public services & social spaces within walking distance.
- **Layered Composition Principle**: Adopt a three-dimensional layered design of ground level (streets & setback spaces), building interface level (ground floor overhead & exhibition), & aerial level (corridors & roof gardens), maximizing the vertical supply efficiency of public space.
- **Elastic Adaptation Principle**: Street facilities adopt a modular, dismountable design strategy, capable of flexibly adjusting spatial configuration according to the pace of industrial settlement, changes in population scale, & needs of event hosting.
- **Sci-Tech Aesthetics Principle**: Street furniture, signage systems, & lighting facilities all adopt a unified sci-tech aesthetic language, highlighting the contemporary characteristics of the AI innovation belt with concise geometric forms, matte metal texture, & intelligent interactive features.

**Spatial Type System**:

Street public space is divided into three tiers according to service radius & functional positioning:
- **Core Node Type** (around the three core plazas & courtyards): Undertaking large-scale events, brand display, & core social functions, with spacious spatial scale & complete facility configuration
- **Community Neighborhood Type** (around rail transit stations): Serving daily commuting & community life, emphasizing convenience & comfort
- **Linear Corridor Type** (along the main diameter): Focusing on slow-traffic experience & landscape viewing, interspersed with small exchange nodes & service facilities

**Street Aesthetics & Genius Loci**:

The aesthetic expression of the diameter-type innovation street is built upon the tension & dialogue between the industrial memory of the Jingzhang Railway heritage & the sci-tech futurism of the AI era. Industrial heritage elements such as railway tracks, switches, & signal lights are preserved as spatial narrative clues, while contemporary languages such as parametrically designed metal components, intelligent interactive screens, & low-illumination point light systems respond to them, forming a unique place temperament of "historical roots & intelligent creation future intertwined & symbiotic".


#### 9.3.5 Inclusive & All-Age Friendly Design
...
#### 9.4.1 Four-Tier Time Cycle Framework

| Time Scale | Cycle | Design Theme | Core Goal |
|---|---|---|---|
| Annual Cycle | Spring/Summer/Autumn/Winter | Spring Flowers · Summer Shade · Autumn Colors · Winter Bones | Scenery in all seasons, visitable year-round |
| Daily Cycle | Morning/Noon/Evening/Night | Commute · Vitality · Leisure · Mid-Night | Full-day vitality, 24-hour liveliness |
| Weekly Cycle | Weekdays/Weekends | Efficient Weekdays · Vibrant Weekends | Live-work balance, weekly rhythm adjustment |
| Life Cycle | Near/Mid/Long-term | Startup · Growth · Maturity | Dynamic growth, continuous evolution |

#### 9.4.2 Annual Cycle: Four Seasons Landscape & Activities

- **Spring (Mar-May)**: Flower Path + Innovation Germination Season — AI Spring Forum, Youth Entrepreneurship Festival, Cherry Blossom Tech Festival
- **Summer (Jun-Aug)**: Shade Path + Creative Growth Season — Summer Night AI Film Festival, Sci-Tech Market, Hackathon
- **Autumn (Sep-Nov)**: Color Path + Achievement Harvest Season — Golden Autumn Sci-Tech Week, AI Industry Expo, Innovation Summit
- **Winter (Dec-Feb)**: Bone Path + Preparation Season — Ice & Snow Tech Festival, AI Winter Camp, New Year Light Show

#### 9.4.3 Daily Cycle: Six-Time-Slot Function & Atmosphere

| Time Slot | Mode | Core Function | Facility Status |
|---|---|---|---|
| 6:00-8:00 | Morning Awakening | Running, cycling, commute | Path lighting fades out, breakfast carts activate |
| 8:00-10:00 | Commute Mode | Commute, transfer, breakfast | Bike lane peak, coffee outdoor seating open |
| 10:00-12:00 | Office Mode | Business meetings, outdoor conferences | Innovation courtyards at full capacity |
| 12:00-14:00 | Midday Vitality | Lunch, walking, socializing | Food truck peak, midday performances |
| 14:00-17:00 | Afternoon Office | Afternoon tea, pitch events, walking | Coffee seats, shared pavilions in normal use |
| 17:00-19:00 | Dusk Transition | Off work, fitness, dating | Night lighting gradually on, commerce warming up |
| 19:00-21:00 | Night Leisure | Dining, entertainment, night running | Night market, bars, cinema, music |
| 21:00-24:00 | Mid-Night | Late-night study, 24h office | Low-warm lighting, core nodes active |

**Technical Strategies**: Movable facilities (modular), smart lighting (time-slot adjustment), digital projection (night art), smart scheduling (footfall big data).

#### 9.4.4 Weekly Cycle: Weekday & Weekend Switching

**Weekdays**: Efficiency-first, commute-dominated — morning peak ensures passage, 30-minute midday activities, evening peak commute + fitness overlap.
**Weekends**: Leisure-first, experience-dominated — creative markets, family AI experiences, open-air cinema, slow-travel priority.

#### 9.4.5 Life Cycle: Phased Growth Elastic Framework

> Note: This section covers **long-term spatial growth lifecycle phasing** (2026-2035 vision framework). It operates at a different time scale from Chapter 10's near-term implementation phasing (Startup 2026-2027, Acceleration 2028-2029, Maturity 2030+). The two systems correspond to "spatial growth logic" & "engineering implementation logic" respectively, & do not conflict.

- **Startup Phase (2026-2028)**: Skeleton construction — three core nodes + diameter spine + first-opened courtyards
- **Growth Phase (2029-2032)**: Vitality infill — dual rings complete + all courtyards + community-level facilities
- **Maturity Phase (2033-2035)**: Quality enhancement — full coverage + refined operations + digital twin management

**Elastic Reservation**: Some parcels reserve flexible space, buildings reserve expansion potential, underground space developed on demand, public space designed for reconfiguration.
...
**Location**: Core area of AI Origin Community, intersection of Jingzhang Innovation Diameter & Chengfu Road
**Height**: ~150 meters, 30 floors
**Building Area**: ~200,000㎡
**Functions**:
- AI enterprise headquarters & R&D center
- AI innovation service hub (sci-tech finance, intellectual property, policy services)
- AI technology exhibition & experience center
...
- The commanding height & spiritual landmark of the innovation belt
- Symbolizing the core position as AI technology source
- A new sci-tech innovation landmark in western Beijing

#### Landmark 2: Jingzhang Railway Memorial Hall (No.2 Innovation Root)

**Location**: Middle section of Jingzhang Railway Heritage Park (south of Collective Intelligence Park)
**Building Area**: ~30,000㎡
**Functions**:
- Jingzhang Railway historical exhibition
...
**Design Features**:
- Preserve & utilize original station building, renovated & expanded into memorial hall
- Dialogue between old & new buildings, fusion of industrial heritage & modern design
...
- Benchmark for industrial heritage activation & utilization
- Patriotism & innovation spirit education base

#### Landmark 3: Dazhongsi AI Gate (No.3 Innovation Gateway)

**Location**: Dazhongsi district, intersection of North 3rd Ring Road & Jingzhang Diameter
**Height**: ~120 meters, twin tower design
**Building Area**: ~250,000㎡ (total for twin towers)
**Functions**:
- AI leading enterprise headquarters base
- International AI exchange & exhibition center
...
- Entrance plaza: Large AI interactive installation wall, dynamically displaying AI technology & urban data
- Night scene: Flowing light bands along building contours, symbolizing the flow of data & information

**Cultural Significance**:
- Southern gateway image of the innovation belt
- Urban living room welcoming guests from all directions
- Symbolizing AI industry moving from Haidian to the nation & the world

### 9.6 Urban Character Control

#### 9.6.1 Character Zoning Guidance
...
| Heritage Park Integration Belt | Along Jingzhang Heritage Park | Eco + Industrial + Tech fusion | ≤24m | Preserved industrial elements + modern tech materials |
| Living Support Character Zone | East & West Wing Residential Areas | Livable, convenient, community sense | 6-18 floors | Warm tones, human-scale |

#### 9.6.2 Building Height Conceptual Guidance (Non-Statutory)

**Height Control Principles**:
- Building height ≤24m within 100m along Jingzhang Heritage Park, ensuring spatial openness
...
- East & West sides: First rising then falling from the central diameter, forming a "valley" morphology

#### 9.6.3 Street Furniture & Signage System
...
- Incorporating graphic elements such as track lines, circuit boards, & neural networks
...
**Public Art Corridor**: Layout 20+ public art works along Jingzhang Heritage Park
...
**Public Art Program**:
- Establish "Jingzhang Public Art Fund"
...
This proposal constructs a **public space AI component library with 7 categories & 20+ sub-items**, each category supported by corresponding AI technology, enabling "plug-and-play" intelligent space empowerment:

| Component Category | Core Sub-items | AI Technology Support | Technical Originality |
|---|---|---|---|
| ① Generative Landscape Design | AI flower border generation, seasonal vegetation configuration, interactive water feature control | Natural Language to Landscape (NL2Landscape) + plant knowledge graph | Users describe landscape effects in natural language, AI auto-generates planting schemes & construction parameters, responding to seasonal changes in real time |
| ② Multimodal Interactive Navigation | AR historical reconstruction, AI voice guide, gesture recognition interaction | Multimodal LLM + spatial computing + computer vision | Immersive navigation fusing voice/vision/gesture multimodal interaction, supporting free switching between Chinese & English |
...
| ⑦ Digital Twin Operations | Space usage analysis, vitality heat prediction, intelligent activity recommendation | Spatiotemporal data mining + prediction models + operation optimization | Space vitality prediction & automatic operation strategy generation based on historical data & real-time perception |

**Component Library Technical Architecture**: Four-layer architecture of "perception layer — edge computing layer — platform layer — application layer", all components with unified API interfaces, data standards, & security protocols, supporting third-party developer access to form an open AI space component ecosystem.

> The above are conceptual technical suggestions; specific implementation requires special technical verification & security assessment.

### 9.6.6 Honor & Contribution Display System
...
### 9.6.7 agent.4 Delivery Checklist & Taskbook Mapping
...
| ≥3 AI pilgrimage landmarks | AI Origin Tower, Jingzhang Railway Memorial, Dazhongsi AI Gateway (3 core landmarks) | §9.5 AI Pilgrimage Landmarks | Concept design + diagrams | Complete |
...
> **Audit Note**: All deliverables above are conceptual-stage results (provisional), auditable & traceable — spatial data in geometry/, figures in assets/figures/, metrics in metrics.json, sources in sources.json.


## Chapter 10 Renewal Projects, Implementation Policy, & Phasing

> **📌 Task Book Response**: This chapter responds to "Implementation Policy & Phasing", proposing renewal project list, phased implementation path, policy support system, & operations mechanism. All indicators are conceptual research parameters for reference only.


> ⚠️ **Conceptual Research Chapter**: Content in this chapter represents conceptual scenario research parameters. All boundaries/indicators/schemes are provisional & do not constitute statutory basis.
> **Concept Scenario Disclaimer**: All projects, investments, timelines, & policy tools in this chapter are **conceptual scenario assumptions** & do not constitute government commitments or approval conclusions. The initiation, progression, & exit of action packages depend on prerequisites such as superior planning approval, funding availability, & market participant willingness.
...
| 2 | Jingzhang AI Computing Center | Collective Intelligence Park | ~80 | 2026-2027 | Proposed: SOE + leading enterprise joint |
...
|---|---|---|---|
| Industrial Space Category | 20+ | ~300 | AI industry carrier construction & renovation |
...
To ensure the implementability, acceptability, & risk controllability of each project package, establish a standardized project delivery contract framework, clarifying the delivery conditions, acceptance standards, failure disposal methods, & cost estimation methods for each project package.
...
|---|---|---|---|
| **L1 Planning & Design Delivery** | Planning & design documents | Conceptual design schemes, drawings, specifications, technical & economic indicators for professional deepening | Design unit |
...
Establish a three-level failure disposal mechanism to ensure project risks are controllable & losses are recoverable:
...
2. **Serious Level (Deviation Rate 20%-40%)**:
   - Trigger conditions: progress lagging by more than 20%, investment overspending by more than 20%, major quality & safety hazards occurring

3. **Termination Level (Deviation Rate >40% or Fundamental Failure)**:
   - Trigger conditions: project completely infeasible, responsible party losing performance capacity, major violations of laws & regulations

**Cost Estimation Methodology**:

All investment data in this proposal are conceptual estimates. Specific costs need to be recalculated in the next stage based on detailed survey & design.
...
- **Estimation Accuracy & Reserve**:

> **Note**: The project delivery framework described in this section is a conceptual contract model recommendation & does not constitute any legal offer or commitment.
...
- **Middle Undertaking** (AI Origin): when north reaches critical mass & demand emerges, use midpoint geometry (lowest exchange cost) for incubation — demand-driven, reducing vacancy risk
...
Three-phase implementation follows the economic logic of "gradual agglomeration along the quality gradient", with each phase corresponding to different AI technology maturity nodes, ensuring technology supply & spatial construction advance in sync.

##### First Phase: Start-up Period (2026-2027 · Concept Scenario) — Foundation, Image, Demonstration

**Construction Volume**: Launch ~1.5km demonstration section, complete area around Jingzhang Railway Memorial Hall & first phase of AI Origin demonstration zone
...
- Industrial carriers: Three core zone industrial spaces basically occupied & operating
...
- Digital Twin: Full-element full-process digital twin, supporting real-time simulation & prediction
...
**Construction Volume**: Full line improved & enhanced, entering operation iteration phase
...
**AI Technology Maturity Corresponding Nodes**:
- Generative AI: Embodied intelligence popularization, deep integration of physical & digital worlds
...
1. **Foundation Layer: Space Operation Revenue** (physical space rental, property management, event venues, commercial facilities)
   - Basic business of traditional space operators, but space quality continuously optimized & enhanced by AI systems
...
3. **Ecosystem Layer: Ecosystem Flywheel Revenue** (innovation incubation investment, technology transformation revenue sharing, IP licensing, standard export)
   ...
   - Exporting Jingzhang AI innovation standards & spatial design methodology externally

**Revenue Distribution Mechanism**: 30% of AISO revenue feeds back to AI system iteration & upgrading, 20% invests in public space quality maintenance & improvement, 30% covers operation costs, 20% as reasonable returns. This mechanism ensures AI systems continuously evolve with spatial operations, avoiding the traditional smart project dilemma of "ending upon completion".
...
- Maturity Phase: AISO model standardization, export brand & management to other cities
...
The **full-section dynamic governance system** based on digital twin + multi-agent collaboration is the governance infrastructure of the Jingzhang AI Innovation Belt:
...
- **Seven-Star Governance Nodes**: Corresponding to the seven spatial nodes of the Big Dipper, each with a governance agent responsible for perception, analysis, & decision-making within its jurisdiction
...
**Co-creation** means gathering collective wisdom to pose & solve problems. The AI Conjecture Rankings operate through a **five-stage full-cycle process of "Release → Popularity → Challenge → Review → Implementation"**, enabling low-threshold, open participation for all:

1. **Conjecture Release**: Researchers submit AI conjectures. System performs semantic classification & initial quality screening; upon passing, conjectures enter the conjecture pool & open for community discussion.
2. **Popularity Ranking**: Integrates online (likes, bookmarks, discussion depth, citation spread, expert endorsements) & offline (roadshow scores, academic event participation, industrial demand matching) two-dimensional data, with real-time ranking updates via weighted algorithm.
...
4. **Review & Verification**: **Dual-layer mechanism of community review + expert audit**. Community review based on peer evaluation & reputation points; expert audit organized by academic committee with blind review.
...
#### 10.6.2 Co-Building: Collaborative Innovation & Resource Allocation

**Co-building** means pooling collective efforts to coordinate resources & jointly innovate. Through challenge-based supply-demand docking & three-core spatial dynamic allocation, it realizes multi-party co-building of government guidance, market participation, academic support, & community supervision:
...
- **Popularity threshold triggering resource allocation**: Low threshold → co-working & roadshow spaces; medium threshold → labs & computing resources; high threshold → customized industrial space & policy support.
...
- **Talent-space aggregation**: Top performers join talent pool via open application, accessing housing support, research funding & education resources through needs-based, transparent allocation.

#### 10.6.3 Co-Sharing: Public Interest Priority & Universal Guarantee

**Co-sharing** means all people sharing innovation achievements, improving production, life, & ecological quality. Adhering to public interest priority:

**Public Interest Priority Mechanism**:
- Community services, accessibility, elderly-friendliness, environmental health, education equity conjectures labeled "public benefit tags," enjoying popularity weighting & priority display.
- Public interest conjectures receive priority access to offline spatial resources, computing power quotas, & challenge support funding.
...
| **Persons with Disabilities** | Information accessibility standards, spatial accessibility support | Manual guided tours & assistance, one-on-one service |
...
> **Inclusivity Commitment (Concept)**: Public interest priority. All high-quality spaces & services open to all citizens. No talent-exclusive privilege zones. Talent support follows **open qualification, demand-oriented, budget-neutral** principles.
...
#### 10.6.4 AI Removability & Governance Guarantee

Establish a **"access — operation — suspension — exit"** four-tier AI governance architecture, ensuring AI is controllable, stoppable, & removable:
...
| **Suspension Layer** | Anomaly circuit breaker | AI anomaly circuit breaker mechanism, manual takeover process, data freeze & preservation, behavior traceability |
...
**Non-Intelligent Equivalent Service List**: Conjecture release (paper/oral → manual entry), popularity ranking (manual review panel), challenge registration (offline sign-up), review & verification (all expert manual), achievement announcement (offline bulletin + community notification). When AI is unavailable, all core functions can be completed through manual processes.

#### 10.6.5 90-Day Pilot & Expansion Path
...
- **Precise Identification**: Precisely identify high-level talents through continuous behavioral data & achievement performance.
- **Progressive Implementation**: Gradient path from "online participation" to "short-term visits" to "long-term residency."
- **Ecological Self-Reinforcement**: Online talent aggregation improves ranking quality & influence, attracting more talent, promoting offline quality improvement & industrial aggregation, forming positive feedback of "virtual-physical mutual promotion & circular accumulation."

---
## Chapter 11 Metrics, Area Recalculation, & Compliance Matrix

> **📌 Task Book Response**: This chapter responds to the task book requirement for "Indicator System," constructing a 6-dimension 7-degree integrated indicator system with 32 core indicators covering industry, space, ecology, transport, public services, & innovation ecosystem, with area recalculation & compliance matrix for quantifiable monitoring & evaluation.

> ⚠️ **Conceptual Research Chapter**: Content in this chapter represents conceptual scenario research parameters. All boundaries/indicators/schemes are provisional & do not constitute statutory basis.

### 11.0 Core Metrics Master Ledger (Unified Calibration Table) & Dynamic Monitoring Mechanism

**AI-Driven Indicator Dynamic Monitoring & Early Warning System**: This proposal establishes a digital twin-based indicator dynamic monitoring system, realizing closed-loop management of "real-time perception — intelligent analysis — automatic warning — collaborative disposal":

- **Monitoring Dimensions**: Covering 6 categories & 60+ indicators including industrial economy, spatial quality, talent agglomeration, ecological environment, transportation operation, & safety governance
...
- **Disposal Closed Loop**: After warning triggers, automatically dispatch to corresponding governance agent, track disposal progress & review optimization
...
![Core Indicator System & Evidence Chain](assets/figures/metrics-evidence.png)
...
| **Innovation Quality** | Innovative + Smart | Talent density (proportion of bachelor's degree & above) | % | ≥80 | Statistical data | Annual |
...
| | | Annual financing scale | 100 million yuan | Continuous growth | Investment & financing data | Annual |
...
- The 136.8ha reduction in industrial land is mainly transformed into industrial/research land & green space
- The 45.6ha increase in green space mainly comes from Jingzhang Heritage Park quality improvement & new pocket parks
...
- Renovated buildings 2.7 million ㎡ are existing building renovation & upgrading, not counted as increment
- Residential function net decrease of 400,000 ㎡, mainly achieved through old community renovation & functional replacement
...
| Special | Jingzhang Railway Heritage Park Plan | Pending coordination review | Heritage protection, park construction | Function expansion & quality improvement |

**Alignment Notes (Pending Review)**:
- Overall positioning & development direction are broadly aligned with upper-level plans
- Land use layout & building scale to be optimized at regulatory plan level
...
| Industrial Policy | AI industry development policy | Directionally aligned | Consistent with national & Beijing direction |
| Talent Policy | Talent introduction & security policy | Pending pilot review | Some innovations require pilot implementation |
...
| Cultural Relics Protection | Cultural Relics Protection Law | Directionally aligned | Jingzhang Railway heritage protection priority |
...
| Traffic Engineering | Urban Road Engineering Design Code | Pending compliance check | Implement national & local standard direction |
| Municipal Engineering | Various municipal engineering codes | Pending compliance check | Implement national & local standard direction |
...
## Chapter 12 Risk, Copyright, & Compliance
...
#### 12.1.1 Strategic & Implementation Risks
...
#### 12.1.2 AI-Specific Risk & Governance Framework
...
|---|---|---|---|---|---|
| Construction ecological damage | Dust, noise affecting residents & ecology | Medium | Strict construction management, enclosure spraying, night work limits, ecological restoration deposit | Contractor + Ecology Bureau | Dust concentration, noise exceedances, restoration rate |
| Biodiversity loss | Habitat destruction, native species decline | Medium | Ecological compensation, native species priority, wildlife corridors, Jingzhang green corridor connectivity | Landscape Bureau + Planning Institute | Native species ratio, corridor connectivity, bird species count |
...
**Sponge City Design Key Points**: ① Infiltration-retention-storage-purification-use-discharge approach fully covered; ② Jingzhang Heritage Park as core sponge body; ③ Sunken green space ratio ≥50%; ④ Permeable pavement ≥40%; ⑤ Stormwater management model validation.
...
| Slow traffic system discontinuity | Broken pedestrian/bike network | Medium | Slow-traffic priority, physical separation, crossing facilities, Jingzhang greenway full connectivity | Planning Institute + Transport Bureau | Slow network density, crossing spacing, cycling mode share |
...
**Slow System Priority**: Walk > bike > transit > motor vehicle space allocation priority. Jingzhang Heritage Park full-line barrier-free greenway. Metro stations 500m comfortable walking coverage.
...
| Special | Jingzhang Railway Heritage Park Plan | Heritage park boundary, protection requirements | Heritage park as core green corridor, protection first | Pending verification [source:SRC-021] |
...
#### 12.1.7 Implementation & Financial Risks
...
**Financial Risk Prevention**: ① Fund pool with ≥6-month operating reserve; ② Diversified financing, no single source >40%; ③ Dynamic ROI monitoring, cost-cutting plan triggered below threshold; ④ Engineering & property insurance for extreme risk transfer.

**Phased Implementation Risk Mitigation**: Pre-assessment (tech/finance/market feasibility) & post-assessment (effect verification/problem diagnosis/next-phase optimization) before each phase; if prior phase underperforms, adjust next phase scale & pace.

### 12.2 High-Risk AI Governance

**Default-off principle**: High-risk AI capabilities (facial recognition, public video analytics, health/education data, minor data) are **not enabled by default**. Pilot deployment requires independent legal assessment, PIA, ethics review, & public hearing.

#### 12.2.1 Facial Recognition & Public Video Analytics
...
#### 12.2.2 Health & Education Data Governance
...
- Data localization; user rights to delete & correct
- Health data not used for insurance pricing or employment decisions

#### 12.2.3 Autonomous Driving & Robotics Scenarios
...
#### 12.2.4 Governance Structure (Conceptual Framework)
Three-tier governance: AI Ethics & Governance Committee, Data Protection Office, & Scenario Operators.

> All governance frameworks are conceptual design proposals, not compliance conclusions. Real deployment requires compliance with PIPL, DSL, Cybersecurity Law & relevant regulations, plus administrative approval & public participation. This proposal does not constitute any compliance commitment or legal opinion.

### 12.3 Source Audit & Evidence Grading
...
|---|---|---|---|
| formal_approved | Self-assessed formal approval (official policy/regulation/standard/statistics) | Used for formal argumentation & indicator support; final approval subject to organizer | 15 |
| academic_background | Academic background (papers/monographs) | For theoretical framework & methodology support | 3 |
...
Complete source list & grading see . The  tags in the proposal text are the proposal team's internal classification numbers, aligned with organizer-approved source IDs including DATA-SRC-AGENT-TASKBOOK-20260518, DATA-SRC-PROVISIONAL-BOUNDARIES-20260605, DATA-SRC-GENERATIVE-AI-INTERIM-MEASURES, & DATA-SRC-BARRIER-FREE-ENVIRONMENT-LAW. Unmapped sources are uniformly downgraded to background/pending verification in the text.


#### 12.3.2 Evidence Status Mapping

Evidence status is consistent with Section 1.7. See confidence_level fields in sources.json & metrics.json.

#### 12.3.3 Identified Pending-Verification Sources

The following sources are currently at provisional / needs_review level. All relevant citations in the text are marked as "background reference" or "pending verification" & do not serve as formal argumentation basis:
- **SRC-013** (OpenStreetMap spatial data): Only used for temporary geometric boundary conceptual illustration
- **SRC-021** (Centennial Jingzhang Railway Heritage Park Planning): Planning text pending official acquisition, related discussion for background reference only
...
**AI image terms**: All AI images generated via subscribed commercial platforms (Midjourney v6/SDXL 1.0/DALL-E 3), used under their TOS for this submission. All outputs human-reviewed & edited.

**License scope**: All assets uniformly under COMMUNITY-DISPLAY-ONLY — organizer may display, review, discuss & distribute within this open call. Consistent across manifest, compliance_matrix & this section. No commercial use or redistribution beyond event scope.

### 12.5 Planning & Engineering Determinacy Statement

This proposal is conceptual urban design research. All planning, engineering, & approval-related content are conceptual proposals. By determinacy level: Data class (observed/pending verification), Analysis class (theoretical deduction/multi-source cross-validation), Forecast class (scenario hypothesis/requires continuous calibration), Spatial engineering class (conceptual guidance/pending special verification). See Chapter 11 metrics ledger & compliance_matrix.json for detailed determinacy matrix.
...
The complete list of references for this proposal can be found in `sources.json`, which contains 19 authoritative sources. National-level policy bases include the National 15th Five-Year Plan Outline [source:SRC-005] & the New Generation AI Development Plan [source:SRC-005].

Beijing municipal bases include the Beijing 15th Five-Year Plan Outline [source:SRC-006] & Beijing's 15th Five-Year AI Industry Development Plan [source:SRC-003]; district-level bases include the Haidian District 15th Five-Year Plan Outline [source:SRC-007], Haidian District Plan (2017-2035) [source:SRC-020], & the Centennial Jingzhang Railway Heritage Park Plan [source:SRC-021].

The theoretical foundation is centered on Prof. Yang Kaizhong's New Spatial Economics theory [source:SRC-008], covering three major propositions (spatial quality driving talent agglomeration, spatial transaction cost of knowledge exchange, circular cumulative causation) & two mechanisms (linear corridor contact efficiency, quality gradient dynamic agglomeration) [source:SRC-019].

Spatial data sources include Haidian GIS data [metric:haidian-gis^provisional], industry statistics [metric:haidian-stats^provisional], population talent data [metric:haidian-pop^provisional], & transportation data [metric:beijing-transport^provisional]. See sources.json for all [source:SRC-001]~[source:SRC-019].

### 13.2 Planned Research Activities Statement

All field research, building surveys, enterprise interviews, & resident questionnaires are in planned status as of v5.13.3. Planned activities: ① Full-line site reconnaissance (from H2 2026); ② Stakeholder interviews (progress depends on coordination); ③ Continuous review of existing public materials. Research plan is provisional; authorization & compliance must be confirmed before formal implementation.


## Chapter 14 Conclusion & Outlook

This proposal constructs the AI Innovation Belt urban design under the "Central Axis — Diameter" paradigm, with Jingzhang Railway Heritage Park as carrier. Key conclusions:
- The diameter-type structure (One Diameter · Three Cores · Two Rings · Multiple Courts), grounded in New Spatial Economics + circular cumulative causation, outperforms traditional point agglomeration in knowledge spillover efficiency & resilience. [source:SRC-008]
- Focusing on LLMs, embodied intelligence, & AI for Science, the "basic research—scenario validation—industrial transformation" chain targets 300B yuan AI industry & 150K AI talent by 2035. [source:SRC-003]
- "Demolition-Renovation-Retention" strategy + "Co-Creation · Co-Building · Co-Sharing" governance deliver spatial, industrial, & governance renewal.
- Six risk categories each have complete "identification—assessment—mitigation—responsibility—monitoring" closed loops.

**Five Innovations**: ① Theoretical — New Spatial Economics for AI innovation spaces; ② Spatial — "Central Axis-Diameter" paradigm & diameter-type structure; ③ Methodological — Six-Agent collaborative design workflow + DGA; ④ Governance — "Co-Creation·Co-Building·Co-Sharing" AI good governance; ⑤ Cultural — Centennial Jingzhang heritage meets AI spirit.
...
> This proposal is a conceptual research deliverable. Spatial boundaries are provisional. Indicators are research parameters & do not constitute statutory planning. Implementation requires statutory approval & professional verification.
